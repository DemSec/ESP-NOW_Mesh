...
#define SLAVE_SSID "Slave_Controller"

#define STA_MAC_RECEIVER   "24:0A:C4:0E:9E:80"
#define STA_MAC_CONTROLLER "24:0A:C4:0E:9D:F4"
...
void setup()
{
  ...
  esp_now_unregister_send_cb(); // Let's see if this makes it UDP
  esp_now_register_recv_cb(OnDataRecv);
  // typingMotion = true;
  slaveAssign(STA_MAC_RECEIVER);
  // packetRecieved = false;
}
